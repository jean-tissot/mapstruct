...
public class InheritFromConfigTest {
    ...
    @WithClasses({
        DriverDto.class,
        DriverWithCarDto.class,
        DriverWithCarEntity.class,
        DriverWithCarMapperWithAutoInheritance.class,
        AutoInheritedConfig.class
    })
    public void autoInheritedMappingIsAppliedToSubObjectAutoGeneratedMapping() {
        CarDto carDto = newTestDto();
        DriverWithCarDto driverWithCarDto = new DriverWithCarDto();
        driverWithCarDto.setName( "Malcroft" );
        driverWithCarDto.setCar( carDto );

        DriverWithCarEntity driverWithCarEntity =
            DriverWithCarMapperWithAutoInheritance.INSTANCE.toDriverWithCarEntity( driverWithCarDto );

        assertEntity( driverWithCarEntity.getCar() );
        assertThat( driverWithCarEntity.getDriverName() ).isEqualTo( "Malcroft" );
    }
